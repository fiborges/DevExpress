...
{
    public partial class Chart1 : DevExpress.XtraReports.UI.XtraReport
    {
        public Chart1()
        {
            InitializeComponent();
        ...
        private void xrChart1_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            if (chart != null)
            {
                ...
                if (data != null)
                {
                    ...
                    //Console.WriteLine("Range Value chart 1: " + rangeValue);
                    ...
                    if (diagram != null)
                    {
                        ...
                        //Console.WriteLine("Z-Score chart 1: " + zScore);
                        ...
                        // Adicionar um segundo eixo Y para o histograma (Série 2)
